            ...
            <>
               <div className='grid lg:grid-cols-2 px-5 my-16 lg:my-28 container mx-auto max-lg:gap-10'>
                  <div className='text-center'>
                     ...
                     <Button asChild variant={'outline'} className='mt-4 uppercase'>
                        <a href="https://apps.autodesk.com/RVT/en/Detail/Index?id=439862635907036577">
               ...
               <div className='grid lg:grid-cols-2 px-5 my-16 lg:my-28 container mx-auto max-lg:gap-10'>
                  <div className='text-center'>
                     ...
                     <Button asChild variant={'outline'} className='mt-4 uppercase'>
                        <a href="https://www.food4rhino.com/en/app/typusai-formerly-yanusai" target="_blank">
                           Download
                        </a>
                     </Button>
                     <Sheet>
               ...
               <div className='grid lg:grid-cols-2 px-5 my-16 lg:my-28 container mx-auto max-lg:gap-10'>
                  <div className='text-center'>
                     ...
                     <Button asChild variant={'outline'} className='mt-4 uppercase'>
                        <a href="https://h38.294.myftpupload.com/wp-content/uploads/2025/07/TYPUS.AI_AC25-28.zip" download="Yanusconnector_AC_Windows">
                           DOWNLOAD WINDOWS
                        </a>
                     </Button>
